...
#define net_send_(sockfd, timeout, mem, len) net_send(sockfd, timeout, mem, len, 1)
#define net_recv_(sockfd, timeout, poll_w, response_buf, len) net_recv(sockfd, timeout, poll_w, response_buf, len, 1)
